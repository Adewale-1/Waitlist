    ...
    <div className="container">
      {/* <header className="header">
        ...
        <nav className="nav-bar">
          ...
          <Link to="/privacy-policy" className={`nav-links ${location.pathname === '/privacy-policy' ? 'active' : ''}`}>Privacy Policy</Link>
          <Link to="/terms-of-service" className={`nav-links ${location.pathname === '/terms-of-service' ? 'active' : ''}`}>Terms of Service</Link>
        </nav>
      </header> */}
      <header className="header">
      ...
      <footer className="footer">
        ...
        <a href="https://discord.gg/PYAngkfA" target="_blank" rel="noopener noreferrer">
